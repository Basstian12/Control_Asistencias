...
$sql = "SELECT A.fecha, A.hora, A.estatus FROM asistencias AS A LEFT JOIN carga_academica AS C_A
ON A.id_cargaacademica = C_A.id
LEFT JOIN unidad_academica AS UA
ON UA.id_uacademica = C_A.id_uacademica
WHERE A.id_alumno='$id_alumno' AND UA.id_uacademica = '$materia'";
