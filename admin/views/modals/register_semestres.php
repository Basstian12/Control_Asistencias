...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#msemestre">
    Registrar
</button>

<!-- Modal -->
<div class="modal fad" id="msemestre" tabindex="-3" aria-labelledby="modalsemestre" aria-hidden="">
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="modalsemestre">Registrar un semestre</h1>
